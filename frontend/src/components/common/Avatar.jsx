...
export default function Avatar({ src, fallbackInitials, size = 'md', status, className }) {
  ...
  return (
    <div className={cn('relative inline-flex', className)}>
      <div className={cn('rounded-full overflow-hidden flex items-center justify-center bg-industrial-700 text-industrial-100 font-medium border border-industrial-600', sizeClasses[size])}>
